...
1. `../0_common/promptreference.md` を確認し、母艦の元記事は `%USERPROFILE%\OneDrive\開発\Blog_Vercel\ryosan\input\` 配下の最新 Markdown を使う前提を共有する。
...
4. このチャットで `%USERPROFILE%\OneDrive\開発\Blog_Vercel\ryosan\input\<任意の元記事>.md` を土台に `../output/<出力スラッグ>/master_article.md` を作成する。
